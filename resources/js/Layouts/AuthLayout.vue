<template>
    ...
    <div class="min-h-screen w-full gap-5 p-2 md:grid md:grid-cols-12">
        <!-- Side navigation menu -->
        <aside class="w-full rounded-xl bg-white shadow-sm md:col-span-3 lg:col-span-2">
                ...
                <BreezeDropdown align="right" width="48">
                    <template #trigger>
                        <span class="inline-flex items-center rounded-md">
                            <img v-if="$page.props.auth.user.photo" class="mr-1 inline-flex h-8 w-8 rounded-full object-cover ring-1 ring-orange-100 ring-offset-2" :src="$page.props.auth.user.photo" />
