        ...
        <div class="container">
            <div class="px-4 md:px-8">
                <div class="mb-8 flex items-center justify-between">
                    ...
                    <button onclick="popuphandler(true)" class="mt-4 inline-flex items-start justify-start rounded bg-indigo-700 px-6 py-3 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 sm:mt-0">
            ...
            <div class="rounded-lg bg-white py-4 px-4 md:py-7 md:px-8 xl:px-10">
                <div class="items-center justify-between py-3 sm:flex">
                    <div class="flex items-center">
                        ...
                        <a class="ml-4 rounded-full focus:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-indigo-800 sm:ml-8" href="javascript:void(0)">
                    ...
                    <table class="w-full whitespace-nowrap">
                        <tbody>
                            <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:outline-none">
                                ...
                                <td class="pl-5">
                                    <button class="rounded bg-red-100 py-3 px-3 text-sm leading-none text-red-700 focus:outline-none">Due today at 18:00</button>
                                </td>
                                <td class="pl-4">
                                    <button class="rounded bg-gray-100 py-3 px-5 text-sm leading-none text-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300 focus:ring-offset-2">View</button>
                                </td>
                                <td>
                                    <div class="relative px-5 pt-2">
                                        <button class="rounded-md focus:outline-none focus:ring-2" onclick="dropdownFunction(this)" role="button" aria-label="option">
                                        ...
                                        <div class="dropdown-content absolute right-0 z-30 mr-6 hidden w-24 bg-white shadow">
                                            <div tabindex="0" class="w-full cursor-pointer py-4 px-4 text-xs hover:bg-indigo-700 hover:text-white focus:text-indigo-600 focus:outline-none">
                                                <p>Edit</p>
                                            </div>
                                            <div tabindex="0" class="w-full cursor-pointer py-4 px-4 text-xs hover:bg-indigo-700 hover:text-white focus:text-indigo-600 focus:outline-none">
                                                <p>Delete</p>
                            ...
                            <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:outline-none">
                                ...
                                <td class="pl-5">
                                    <button class="rounded bg-gray-100 py-3 px-6 text-sm leading-none text-gray-700 focus:outline-none">Due on 21.02.21</button>
                                </td>
                                <td class="pl-4">
                                    <button class="rounded bg-gray-100 py-3 px-5 text-sm leading-none text-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300 focus:ring-offset-2">View</button>
                                </td>
                            ...
                            <tr class="h-3"></tr>
                            <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:text-indigo-600 focus:outline-none">
                                <td>
                                    <div class="ml-5">
                                        <div class="relative flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-sm bg-gray-200">
                                            <input placeholder="checkbox" type="checkbox" class="checkbox absolute h-full w-full cursor-pointer opacity-0 focus:opacity-100" />
                                ...
                                <td class="pl-5">
                                    <button class="rounded bg-gray-100 py-3 px-7 text-sm leading-none text-gray-700 focus:outline-none">Due tomorrow</button>
                                </td>
                                <td class="pl-4">
                                    <button class="rounded bg-gray-100 py-3 px-5 text-sm leading-none text-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300 focus:ring-offset-2">View</button>
                                </td>
                            ...
                            <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:outline-none">
                                <td>
                                    <div class="ml-5">
                                        <div class="relative flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-sm bg-gray-200">
                                            <input placeholder="checkbox" checked="" type="checkbox" class="checkbox absolute h-full w-full cursor-pointer opacity-0 focus:opacity-100" />
                                            <div class="check-icon hidden rounded-sm bg-indigo-700 text-white">
                                                <svg class="icon icon-tabler icon-tabler-check" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                                                    <path d="M5 12l5 5l10 -10"></path>
                                ...
                                <td>
                                    <div class="relative px-5 pt-2">
                                        ...
                                        <div class="dropdown-content absolute right-0 z-30 mr-6 hidden w-24 bg-white shadow">
                                            <div tabindex="0" class="w-full cursor-pointer py-4 px-4 text-xs hover:bg-indigo-700 hover:text-white focus:text-red-300 focus:outline-none">
                                                <p>Edit</p>
                                            </div>
                                            <div tabindex="0" class="w-full cursor-pointer py-4 px-4 text-xs hover:bg-indigo-700 hover:text-white focus:text-red-300 focus:outline-none">
                                                <p>Delete</p>
                            ...
                            <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:outline-none">
                                <td>
                                    <div class="ml-5">
                                        <div class="relative flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-sm bg-gray-200">
                                            <input placeholder="checkbox" checked="" type="checkbox" class="checkbox absolute h-full w-full cursor-pointer opacity-0" />
                                            <div class="check-icon hidden rounded-sm bg-indigo-700 text-white">
                                                <svg class="icon icon-tabler icon-tabler-check" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                                                    <path d="M5 12l5 5l10 -10"></path>
                            ...
                            <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:outline-none">
                                ...
                                <td class="pl-5">
                                    <button class="rounded bg-gray-100 py-3 px-3 text-sm leading-none text-gray-700 hover:bg-gray-200 focus:outline-none">Due Today at 18:00</button>
                                </td>
                                <td class="pl-4">
                                    <button class="rounded bg-gray-100 py-3 px-5 text-sm leading-none text-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300 focus:ring-offset-2">View</button>
                                </td>
