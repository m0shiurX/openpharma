                    ...
                    <table class="w-full table-auto whitespace-nowrap">
                        <tbody class="">
                            <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:outline-none">
                                ...
                                <td class="pl-5">
                                    <button class="rounded bg-red-100 py-3 px-3 text-sm leading-none text-red-700 focus:outline-none">
                                        Due today at 18:00
                                    </button>
                                </td>
                                <td class="pl-4">
                            ...
                            <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:outline-none">
                                ...
                                <td class="pl-5">
                                    <button class="rounded bg-gray-100 py-3 px-6 text-sm leading-none text-gray-700 focus:outline-none">
                                        Due on 21.02.21
                                    </button>
                                </td>
                                <td class="pl-4">
                            ...
                            <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:text-indigo-600 focus:outline-none">
                                ...
                                <td class="pl-5">
                                    <button class="rounded bg-gray-100 py-3 px-7 text-sm leading-none text-gray-700 focus:outline-none">
                                        Due tomorrow
                                    </button>
                                </td>
                                <td class="pl-4">
