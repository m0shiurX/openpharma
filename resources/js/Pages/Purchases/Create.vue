            ...
            <div class="px-4 md:px-8 xl:px-10 rounded-lg">
                ...
                <form class="" @submit.prevent="saveItem">
                    <div class="mx-auto w-4xl max-w-4xl">
                        <!-- Invoice header-->
                        <div class="border-orange-100 mb-6 px-5 py-3 border rounded-xl">
                            <div class="flex justify-between items-center divide-x-2">
                                ...
                                <div class="flex flex-1 items-center pl-2">
                                    ...
                                    <div class="flex flex-col ml-2">
                                        <span class="font-semibold text-slate-500 text-sm">{{ manufacturer.name }}</span>
                        ...
                        <div class="mt-6">
                                    ...
                                    >
                                        ...
                                        >
                                            <li
                                                ...
                                                :key="medicine.id"
                                                class="relative border-orange-200 border-y hover:border-y hover:border-orange-300 hover:bg-orange-200 focus:bg-orange-200 py-2 pr-4 pl-10 w-full text-slate-900 cursor-pointer"
                                                role="option"
                                                tabindex="-1"
                                                value="0"
                            ...
                            <table class="w-full whitespace-nowrap table-auto">
                                <thead>
                                    <tr class="border-gray-100 bg-white border rounded-lg h-12 text-base text-gray-500 focus:outline-none">
                                        <th class="border-gray-100 pr-2 pl-5 border-r text-left">Medicine</th>
                                        <th class="border-gray-100 border-x pl-5 w-32 text-left">BATCH</th>
                                        <th class="border-gray-100 border-x pl-5 w-32 text-left">Expiry</th>
                                        <th class="border-gray-100 border-x pl-5 w-32 text-left">Qty</th>
                                        <th class="border-gray-100 border-x pl-5 w-32 text-left">Rate</th>
                                        <th class="border-gray-100 border-x pl-5 w-32 text-left">MRP</th>
                                        <th class="border-gray-100 border-x pr-2 pl-3 text-left W-20">VAT</th>
                                        <th class="border-gray-100 border-x pr-3 pl-5 w-32 text-left">Total</th>
                                    ...
                                    <template v-for="(formRow, index) in form.purchase_items" :key="index">
                                        ...
                                        >
                                            <td class="border-gray-100 h-10">
                                                <div class="flex flex-col justify-center items-start bg-slate-100 px-2 h-full capitalize">
                                                    {{ formRow.name }} <br />
